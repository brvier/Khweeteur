...
setup(name='khweeteur-experimental',
      ...
      long_description="Experimental Version\nKhweeteur is a small twitter client for Maemo and MeeGo. It showing DMs, mentions and the follower timeline in one window, with a subsequent window for each search. Maemo's notification system is supported, as is auto-update and themeing.",
      ...
      'changelog':'* Major changes in the cache format to speed up and lower number of api calls, Some minor fixes for usage on desktop, Strip unnecessary space when user copy paste auth token that can be introduce by microb copy, changes in the notifications',
      'architecture':'any',
      'postinst':"""#!/bin/sh
