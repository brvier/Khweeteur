...
__author__ = "Benoît HERVIER <khertan@khertan.net>"
__version__ = "0.5.0"
...
class Daemon(QApplication):
    ...
    def run(self):
        ...
        daemon = Pyro.core.Daemon(port=objects.PYRO_PORT)
        uri=daemon.connect(objects.Accounts(),'Accounts')
        print dir(daemon)
