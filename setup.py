...
setup(name='khweeteur',
      ...
      'buildversion':'2',
      'depends':'python2.5, pyside-mobility-location, python-pyside.qtmaemo5, python-pyside.qtwebkit, python-pyside.qtcore, python-pyside.qtgui, python-oauth2, python-simplejson, python-conic, python-imaging, python-dbus, python-oauth',
