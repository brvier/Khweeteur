...
class KhweeteurDaemon(Daemon):
    def run(self):        
        ...
        gobject.timeout_add(10,self.retrieve)
    ...
    def retrieve(self):
        try:
            ...
            if not settings.contains('refresh_interval'):
                ...
                refresh_interval = int(settings.value('refresh_interval'))*60000
        ...
        gobject.timeout_add(refresh_interval,self.retrieve)
        return False
